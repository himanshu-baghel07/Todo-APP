...
const App = () => {
  ...
  // State for managing the selected filter option
  const [selectedFilter, setSelectedFilter] = useState(null);
  // State for managing the selected sort option
  const [selectedSort, setSelectedSort] = useState("");
  // State for managing the title (filter type)
  ...
  const ID = uuidv4();
  // Function to get the initial list of tasks from localStorage
  ...
  // Effect to store the updated todo list in localStorage whenever the state changes
  ...
  // Effect to update the current date and time every 3 seconds
  useEffect(() => {
